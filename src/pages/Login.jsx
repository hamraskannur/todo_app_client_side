  ...
  return (
    <div className='grid w-full h-screen lg:grid-cols-2 p-8'>
      <div className='w-full h-full relative'>
        ...
        <img className='absolute top-10 left-10 w-24 rounded-md' src={logo} alt="" />
      </div>
      <div className='flex flex-col p-32'>
        ...
        <form onSubmit={handleSubmit}>
          <div className='mt-10'>
            ...
            <button type='submit' className='bg-[#6f6f6f] rounded-lg w-full p-3 mt-5 border hover:bg-white text-white duration-300 border-[#6f6f6f] hover:text-[#6f6f6f]'>Login</button>
          </div>
        </form>
